...
(function () {
    ...
    /* =========================================================
       ...
       SOMENTE textos exatos.
       Não traduz nomes técnicos automaticamente.
       ========================================================= */
    ...
    function updateLanguageButton() {
        ...
        const language =
            CONFIG.languages[currentLanguage];
    ...
    /* =========================================================
       TRADUÇÃO DE TEXTOS EXATOS DO PAINEL
       ========================================================= */
    ...
    /* =========================================================
       ...
       O GSM Theme pode carregar conteúdo depois.
       Aqui detectamos elementos adicionados dinamicamente.
       ========================================================= */
    ...
    function init() {
        ...
        /* GSM Theme pode carregar componentes
           depois do DOM inicial. */

        [500, 1200, 2500, 5000].forEach(
            function (delay) {
